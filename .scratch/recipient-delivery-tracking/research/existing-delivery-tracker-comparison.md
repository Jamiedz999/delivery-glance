...
> **范围注记（2026-08-09）：** 本文是命名与差异化阶段的历史研究，当时若干决策尚未关闭。现在 [Ticket 12](../issues/12-rescope-to-resume-ready-core.md) 与 [Wayfinder map](../map.md) 已定义精简 Core；下文的“开放决策”和 ETA/完整 Link 生命周期描述不再是当前 Core 承诺。
...
- 产品与架构决策现已关闭；[Ticket 12](../issues/12-rescope-to-resume-ready-core.md) 取代本文研究时的开放状态。
...
- 产品范围以 [Ticket 12](../issues/12-rescope-to-resume-ready-core.md) 为准。
