...
Status: current
Supersedes for Core implementation: the heavier parts of [Ticket 10](../issues/10-choose-core-technical-architecture.md)
Scope authority: [Ticket 12](../issues/12-rescope-to-resume-ready-core.md)
...
Those omissions are preserved as [Future Work Issues 13–19](../map.md#future-work-issues), not silently forgotten work.
