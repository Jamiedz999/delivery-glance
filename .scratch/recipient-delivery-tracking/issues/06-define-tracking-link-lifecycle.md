...
> **Portfolio Core scope update:** [Ticket 12](12-rescope-to-resume-ready-core.md) retains secure creation, repeatable Copy and automatic Expiry. Rotation, Revocation, Reissue and their history remain preserved here for [Future Work 14](14-add-tracking-link-recovery.md).
...
The supporting primary-source review is [Tracking Link security research](../research/tracking-link-security.md).
