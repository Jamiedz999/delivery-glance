...
> **Portfolio Core scope update:** [Ticket 12](12-rescope-to-resume-ready-core.md) implements only Awaiting Courier → Assigned → In Transit → Delivered plus pre-pickup Cancelled. Reassignment and Undeliverable remain preserved here for [Future Work 15](15-add-delivery-exceptions-and-reassignment.md).
