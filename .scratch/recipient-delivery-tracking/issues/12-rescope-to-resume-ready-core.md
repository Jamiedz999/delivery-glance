...
1. [external travel-time ETA and honest unavailable/late presentation](13-add-travel-time-eta.md);
2. [Tracking Link Rotation/Revocation/Reissue and recovery audit](14-add-tracking-link-recovery.md);
3. [pre-pickup Reassignment and Undeliverable outcomes](15-add-delivery-exceptions-and-reassignment.md);
4. [Service Zone polygons and explainable recommendation overrides](16-add-service-zones-and-explainable-overrides.md);
5. [the full top-three, sixty-second Courier Matching Round](17-add-ranked-multi-courier-matching-round.md);
6. [a measured scale and resilience experiment](18-run-measured-scale-and-resilience-experiment.md), introducing Redis, PostGIS, WebFlux or observability tooling only for the bottleneck it proves; and
7. [a durable domain-event backbone](19-evaluate-durable-domain-event-backbone.md) only after a new non-location consumer makes replay valuable.
