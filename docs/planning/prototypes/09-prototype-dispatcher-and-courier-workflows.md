...
> **Portfolio Core scope update:** The focused desktop/mobile workspace structure remains useful, but Core replaces the prototype's Matching Round with Direct Assignment and omits exception branches. The richer interactions are retained for [Future Work 15](../future-work/15-add-delivery-exceptions-and-reassignment.md) and [Future Work 17](../future-work/17-add-ranked-multi-courier-matching-round.md).
