...
This glossary names both the implemented Core language and intentionally preserved Later Backlog language. Defining a term here does not put it into Core; [Ticket 12](.scratch/recipient-delivery-tracking/issues/12-rescope-to-resume-ready-core.md) is the current scope boundary.
